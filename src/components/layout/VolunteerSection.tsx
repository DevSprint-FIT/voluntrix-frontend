...
export default function VolunteerSection() {
  return (
    <div className="bg-gradient-to-r from-[#D0FBE7] to-[#ECFDF6] w-full py-16 px-12 text-center flex items-center justify-center gap-36">
      <div className="max-w-lg pl-6 md:pl-8 md:text-left ">
        <h1 className=" text-3xl  text-gray-900 font-primary">
