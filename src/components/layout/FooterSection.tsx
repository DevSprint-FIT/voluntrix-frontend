      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
          <div className="flex items-center justify-center md:justify-start gap-2">
            ...
            <h2 className="text-lg font-bold font-primary text-[18px]">Voluntrix</h2>
          </div>
        ...
        {/* Contact Section */}
        <div>
          <h3 className="text-md font-semibold font-primary text-[14px]">Contact Us</h3>
          <p className="text-gray-600 mt-2 text-[14px] font-primary" >Email: support@voluntrix.com</p>
          <p className="text-gray-600 text-[14px] font-primary">Phone: (+94) 71-456-7890</p>
        </div>

        {/* Newsletter Section */}
        <div>
          <h3 className="text-md font-semibold font-primary text-[14px]">Stay In Touch</h3>
          <p className="text-gray-600 mt-2 font-primary text-[14px]">
