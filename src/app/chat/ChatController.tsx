...
export default function ChatController({
  ...
  if (chatState === 'login') {
    return (
      <div className="min-h-screen bg-black flex justify-end">
  ...
  if (chatState === 'chatList') {
    return (
      <div className="min-h-screen bg-black flex justify-end">
        ...
        {/* <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center">
            <div className="w-32 h-32 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a3 3 0 01-3-3V9a3 3 0 013-3h8z"
                />
              </svg>
            </div>
            ...
            <p className="text-gray-300 max-w-md">
              ...
              Connect with sponsors and volunteers to make a positive impact
              together.
            </p>
          </div>
        </div> */}
        ...
        <div
          className={`w-96 bg-white shadow-xl transform transition-transform duration-500 ease-out ${
