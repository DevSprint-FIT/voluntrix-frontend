...
const ProfileFormPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.instituteEmail.trim()) {
      newErrors.instituteEmail = "Institute email is required";
    } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.instituteEmail)) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-verdant-50 via-white to-verdant-100">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        >
          <h1 className="text-4xl font-bold text-shark-950 mb-4 font-secondary">
            Complete Your Volunteer Profile
          </h1>
          <p className="text-lg text-shark-600 mb-2 font-primary">
            Welcome {user?.fullName}! Let&apos;s set up your volunteer profile.
          </p>
          <p className="text-sm text-shark-500 font-primary">
            Help us connect you with the right volunteering opportunities
          </p>
        </motion.div>
        ...
        //   title="Verify Institute Email"
        //   description="We've sent a verification code to your institute email address. Please enter the code to verify your affiliation."
        />
      </div>
    </div>
  );
