...
const SettingsPage = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="w-10 h-10 border-4 border-shark-950 border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }
  ...
  return (
    <div className="p-5">
        <span className="text-shark-300 text">Organization / Settings</span>
      ...
      <div className="bg-shark-50 shadow rounded-2xl p-6 mb-6 pr-20 pl-10">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="mb-4">{organization.email}</p>
          ...
          <div className="flex flex-col ">
            ...
            <p className="font-secondary text-shark-600">@{organization.username.replace(/\s+/g, '')}</p>
            <p className="font-secondary text-shark-950 mt-2 font-medium">Account Number</p>
            <p className="font-secondary text-shark-600">{organization.accountNumber}</p>
          </div>
        </div>
    </div>
