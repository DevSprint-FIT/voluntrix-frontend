  ...
  if (chatState === 'chatList') {
    return (
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-green-50 to-green-100">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Welcome {currentUser}!</h2>
      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-blue-50 to-blue-100">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Private Chat</h3>
            <p className="text-gray-600">
              You're chatting with <span className="font-semibold text-blue-600">{selectedUser}</span>
            </p>
